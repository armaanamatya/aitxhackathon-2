...
echo "Preprocessing Ablation Study"
echo "========================================"
date
...
# Experiment 1: Baseline (no preprocessing, full data)
echo ""
echo "Experiment 1: Baseline (full 577 pairs, no preprocessing)"
...
echo ""
echo "Experiment 2: Light augmentation (flip only)"
/cm/local/apps/python39/bin/python3 train_restormer_cleaned.py \
    --train_jsonl train.jsonl \
    --resolution $RESOLUTION \
    --batch_size $BATCH_SIZE \
...
# Experiment 3: Standard augmentation
echo ""
echo "Experiment 3: Standard augmentation (flip + rotation)"
/cm/local/apps/python39/bin/python3 train_restormer_cleaned.py \
    --train_jsonl train.jsonl \
    --resolution $RESOLUTION \
    --batch_size $BATCH_SIZE \
...
# Experiment 4: Exposure normalization
echo ""
echo "Experiment 4: Exposure normalization"
/cm/local/apps/python39/bin/python3 train_restormer_cleaned.py \
    --train_jsonl train.jsonl \
    --resolution $RESOLUTION \
    --batch_size $BATCH_SIZE \
...
echo ""
echo "Experiment 5: Histogram matching"
/cm/local/apps/python39/bin/python3 train_restormer_cleaned.py \
    --train_jsonl train.jsonl \
    --resolution $RESOLUTION \
    --batch_size $BATCH_SIZE \
