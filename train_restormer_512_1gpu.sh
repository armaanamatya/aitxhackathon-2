...
# =============================================================================
# Restormer 512x512 Training with DeepSpeed ZeRO-3 (1 GPU)
# =============================================================================
# Uses DeepSpeed ZeRO-3 with full CPU offloading for max memory efficiency
# Resolution: 512x512
# GPU: 1 x A100 80GB
# =============================================================================

echo "=========================================="
echo "Restormer 512x512 - DeepSpeed ZeRO-3"
echo "=========================================="
...
# Run with DeepSpeed launcher (single GPU)
