...
#SBATCH --mem=64G
#SBATCH -t 24:00:00
#SBATCH -o train_mamba_384_%j.out
#SBATCH -e train_mamba_384_%j.err
#SBATCH -J mamba_384

echo "=========================================="
echo "MambaDiffusion 384x384 - 1 GPU"
echo "=========================================="
...
print('Creating MambaDiffusion model...')
...
output_dir = Path('outputs_mamba_384')
...
for epoch in range(100):
    ...
    with torch.no_grad():
        for batch in val_loader:
            with autocast():
                out = model(batch['source'].to(device))['output']
