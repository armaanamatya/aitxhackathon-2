...
#SBATCH --mem=64G
#SBATCH -t 24:00:00
#SBATCH -o train_restormer_384_v2_%j.out
#SBATCH -e train_restormer_384_v2_%j.err
#SBATCH -J rest_384

echo "=========================================="
echo "Restormer 384x384 - Proper Train/Val/Test"
echo "=========================================="
...
# Optimized hyperparameters for 384:
# - Lower LR with warmup to prevent early instability
...
output_dir = Path('outputs_restormer_384_v2')
