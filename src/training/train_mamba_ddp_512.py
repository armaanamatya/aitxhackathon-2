#!/usr/bin/env python3
"""
MambaDiffusion DDP Training - 512x512
======================================

Multi-node training with PyTorch DistributedDataParallel.
Uses gradient checkpointing and mixed precision for memory efficiency.

Features:
- PyTorch DDP across multiple nodes
...
def train(args):
    ...
    if rank == 0:
        print(f"\n{'='*60}")
        print("MambaDiffusion DDP Training - 512x512")
        print(f"{'='*60}")
    ...
    # EMA
    ema = EMA(model_module, decay=0.999)
