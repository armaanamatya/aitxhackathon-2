...
#SBATCH --mem=64G
#SBATCH -t 24:00:00
#SBATCH -o train_restormer_pretrained_384_%j.out
#SBATCH -e train_restormer_pretrained_384_%j.err
#SBATCH -J rest_pre

echo "=========================================="
echo "Restormer 384x384 with Pretrained Weights"
echo "=========================================="
...
output_dir = Path('outputs_restormer_pretrained_384')
