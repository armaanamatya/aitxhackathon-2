...
#SBATCH --mem=64G
#SBATCH -t 24:00:00
#SBATCH -o train_restormer_1024_%j.out
#SBATCH -e train_restormer_1024_%j.err
#SBATCH -J rest1024

echo "=========================================="
echo "Restormer 1024x1024 - 1 GPU"
echo "=========================================="
...
class HDRDataset(Dataset):
    def __init__(self, data_root, jsonl_path, split='train', crop_size=1024):
    ...
    def __getitem__(self, idx):
        ...
        # Resize to crop_size (may need to upscale small images)
...
train_ds = HDRDataset('.', 'train.jsonl', 'train', 1024)
val_ds = HDRDataset('.', 'train.jsonl', 'val', 1024)
print(f'Train: {len(train_ds)}, Val: {len(val_ds)}')

# Batch size 1 for 1024x1024
...
output_dir = Path('outputs_restormer_1024')
