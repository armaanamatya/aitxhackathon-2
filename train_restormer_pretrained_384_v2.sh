...
#SBATCH --mem=64G
#SBATCH -t 24:00:00
#SBATCH -o train_restormer_pretrained_384_v2_%j.out
#SBATCH -e train_restormer_pretrained_384_v2_%j.err
#SBATCH -J rest_pre

echo "=========================================="
echo "Restormer 384x384 Pretrained - Slow Convergence"
echo "=========================================="
...
ckpt = torch.load('pretrained/restormer_mapped.pth', map_location='cpu')
missing, unexpected = model.load_state_dict(ckpt['state_dict'], strict=False)
print(f'Loaded {ckpt[\"matched\"]} pretrained weights')
...
# Slower convergence settings for pretrained model:
# - Very low base learning rate (1e-5)
...
output_dir = Path('outputs_restormer_pretrained_384_v2')
