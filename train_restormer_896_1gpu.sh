...
#SBATCH --mem=64G
#SBATCH -t 24:00:00
#SBATCH -o train_restormer_896_%j.out
#SBATCH -e train_restormer_896_%j.err
#SBATCH -J rest896

echo "=========================================="
echo "Restormer 896x896 - 1 GPU"
echo "=========================================="
...
class HDRDataset(Dataset):
    def __init__(self, data_root, jsonl_path, split='train', crop_size=896):
...
output_dir = Path('outputs_restormer_896')
